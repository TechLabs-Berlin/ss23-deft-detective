            ...
            <div className="container">
                ...
                <div className="previewContainer">
                    ...
                    <div className="previewQuestion">
                        <h4>When</h4>
                        <div className="data">
                            <p>{formData.whenData.date1} to {formData.whenData.date2}</p>
                    ...
                    <div className="previewQuestion">
                        ...
                        <div>
                            ...
                            <button className="deleteButton" onClick={deleteSelectedParagraphs}>Delete Selected</button>
                        </div>
                    </div>
